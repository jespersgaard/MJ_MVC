...
<?php
	...
	<li class="span3"><div class="thumbnail"><div><div class="row"><div class="span3"><div class="row">
		<div class="span1"><a href="#" class="thumbnail"><img src="http://placehold.it/60x60" alt=""></a></div>
			<div class="span2"><h4><strong><a href="<?php echo URL ?>/public/img/demo/user-avatar.jpg" class="btn btn-success"><i class="icon-zoom-in"></i> ' . $value['name'] . '</a></strong></h4></div></div>
		<div class="row"><div class="span3"><p>' . $value['description'] . '</p></div></div>
		<div class="row"><div class="span3">				
			<small>
				<p></p>
				<p>
				  <i class="icon-user"></i> Owner <a href="#">John</a> 
				  | <i class="icon-calendar"></i> Sept 16th, 2012<p>
