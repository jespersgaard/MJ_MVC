...
?>
	<div class="row span12">
		...
		<div class="span12">
			<div class="span8">
				<p><hr width='100%'>
                                    <a href="#new-task" data-toggle="modal" class='btn btn-success' ><i class='icon-time'></i> Create New Task</a>			
                                    <a href='" . URL . "documentation/filemanager' class='btn btn-success'><i class='icon-tasks'></i> Add New Sprint</a>
