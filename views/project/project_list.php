	<div class="page-header">	
		...
		<div>
			<a href='" . URL . "project/project_list' class='btn btn-primary' id='activities'><i class='icon-list'></i> List</a>			
			<a href='" . URL . "project/project_gitter' class='btn' id='activities'><i class='icon-th'></i> Grid</a>											
			<hr width='100%'>
		</div>	
		"; ?>
	</div>
	...
	<table class="table table-hover table-nomargin">
					...
					<tbody>
						<tr>
							<td class="span2"><a href="#"><h4>Framework</h4>
								<a href="#" class="thumbnail"><img src="http://placehold.it/60x60" alt="">
							</a>							
							</a></td>
							<td>
							...
							<td class='hidden-350 span2'><a href="#">John</a></td>
							<td class='hidden-480 span2'>Sept 16th, 2012</td>
						</tr>
						<tr>
							<td class="span2"><a href="#"><h4>Framework</h4>
								<a href="#" class="thumbnail"><img src="http://placehold.it/60x60" alt="">
