	...
	<script src='<?php echo URL . "public/js/plugins/jquery-ui/jquery.ui.resizable.min.js"; ?>'></script>
	<script src='<?php echo URL . "public/js/plugins/jquery-ui/jquery.ui.sortable.min.js"; ?>'></script>
	<script src='<?php echo URL . "public/js/plugins/jquery-ui/jquery.ui.selectable.min.js"; ?>'></script>
	<script src='<?php echo URL . "public/js/plugins/jquery-ui/jquery.ui.droppable.min.js"; ?>'></script>
	...
	<!-- XEditable -->
	<script src='<?php echo URL . "public/js/plugins/momentpublic/js/jquery.moment.js"; ?>'></script>
	<script src='<?php echo URL . "public/js/plugins/mockjax/jquery.mockjax.js"; ?>'></script>
	<script src='<?php echo URL . "public/js/plugins/xeditable/bootstrap-editable.min.js"; ?>'></script>
	<script src='<?php echo URL . "public/js/plugins/xeditable/demo.js"; ?>'></script>
	<script src='<?php echo URL . "public/js/plugins/xeditable/address.js"; ?>'></script>
	<!-- Flot -->
	...
	<!-- TagsInput -->
	<script src='<?php echo URL . "public/js/plugins/tagsinput/jquery.tagsinput.min.js"; ?>'></script>
	<!-- Custom file upload -->
	<script src='<?php echo URL . "public/js/plugins/fileupload/bootstrap-fileupload.min.js"; ?>'></script>
	<!-- select2 -->
	...
	<script src='<?php echo URL . "public/js/demonstration.js"; ?>'></script>
	</body>
</html>